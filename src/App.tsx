  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden">
      ...
      <Routes>
        ...
        <Route
          path="/business/pet/:petId/home"
          element={<PetBusinessHomePage />}
        />
        <Route
          path="/business/pet/:petId/add-vaccine"
          element={<AddVaccinePage />}
        />
        <Route
          path="/business/pet/:petId/upload"
          element={<UploadDocuments />}
        />
        <Route
          path="/business/pet/:petId/vaccine"
          element={<BusinessVaccinesPage />}
        />
        <Route
          path="/business/pet/:petId/documents"
