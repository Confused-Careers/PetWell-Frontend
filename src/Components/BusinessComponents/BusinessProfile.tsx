...
const BusinessProfile: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/30">
      <div className="bg-[#FFF8E5] rounded-lg p-6 w-full max-w-md mx-4 border relative max-h-[90vh] overflow-y-auto hide-scrollbar">
        ...
        <h2 className="text-2xl font-medium mb-3 text-[#1C232E] font-[Cabin,sans-serif]">Edit Profile</h2>
        <form className="space-y-4" onSubmit={e => { e.preventDefault(); handleSubmit(e as any); }}>
          <div>
            <label className="block text-sm font-medium text-[#1C232E] mb-1">What's the name of your business?</label>
            <input
              type="text"
              name="business_name"
          ...
          <div>
            <label className="block text-sm font-medium text-[#1C232E] mb-1">Upload a profile picture</label>
            <div className="flex items-center gap-3">
              ...
              <label className="flex items-center gap-1 cursor-pointer text-[#FFB23E] font-medium">
                ...
                <span className="text-sm flex items-center gap-1"><span className="text-lg"><PencilLine className="size-4 text-[var(--color-card-button)]" /></span> Edit picture</span>
              </label>
            </div>
          </div>
          <div>
            <label className="block text-sm font-medium text-[#1C232E] mb-1">What is your business phone number?</label>
            <input
              type="tel"
              name="phone"
          ...
          <div>
            <label className="block text-sm font-medium text-[#1C232E] mb-1">What is your business email?</label>
            <input
              type="email"
              name="email"
          ...
          <div>
            <label className="block text-sm font-medium text-[#1C232E] mb-1">How would you like to be contacted by the pet parent?</label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="contact_email" className="accent-[#FFB23E] w-4 h-4" />
                <span className="text-sm">Email</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="contact_phone" className="accent-[#FFB23E] w-4 h-4" />
                <span className="text-sm">Phone Call</span>
              </label>
            </div>
          </div>
          <div>
            <label className="block text-sm font-medium text-[#1C232E] mb-1">Please provide a short description of your business</label>
            <textarea
              name="description"
          ...
          <div>
            <label className="block text-sm font-medium text-[#1C232E] mb-1">What is your business address?</label>
            <input
              type="text"
              name="address"
          ...
          <div>
            <label className="block text-sm font-medium text-[#1C232E] mb-1">Do you have a website?</label>
            <input
              type="url"
              name="website"
          ...
          <div>
            <label className="block text-sm font-medium text-[#1C232E] mb-1">Are you on social media?</label>
            <div className="flex flex-col gap-2 mt-1">
              <div className="flex items-center gap-2">
                <span className="text-xl"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
  ...
  <g clip-path="url(#clip0_1021_9372)">
    ...
    <path d="M33.3422 30.9375L34.4062 24H27.75V19.498C27.75 17.6001 28.6798 15.75 31.6612 15.75H34.6875V9.84375C34.6875 9.84375 31.941 9.375 29.3152 9.375C23.833 9.375 20.25 12.6975 20.25 18.7125V24H14.1562V30.9375H20.25V47.7083C21.4719 47.9001 22.7242 48 24 48C25.2758 48 26.5281 47.9001 27.75 47.7083V30.9375H33.3422Z" fill="white"/>
  </g>
  <defs>
