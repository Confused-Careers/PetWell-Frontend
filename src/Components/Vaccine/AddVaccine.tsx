    ...
    <div className="w-full flex flex-col items-center justify-center">
      <div className="flex flex-col items-center w-full mb-6">
        ...
        >
          ...
          <path
            d="M60.6838 38.5917C61.416 37.8594 62.603 37.8594 63.3352 38.5917L81.4104 56.6659C82.1426 57.3981 82.1426 58.586 81.4104 59.3182C80.6782 60.0504 79.491 60.05 78.759 59.3182L76.0676 56.6268L70.1574 62.537C69.0368 62.2737 67.8681 62.1337 66.6672 62.1337C58.2727 62.1339 51.468 68.9393 51.468 77.3339C51.468 78.5122 51.601 79.6594 51.8547 80.7606C50.8355 81.5368 49.598 81.9589 48.2951 81.9589H40.6945L31.2014 91.451C30.4691 92.1833 29.2821 92.1833 28.55 91.451C27.818 90.7188 27.8179 89.5318 28.55 88.7997L38.0432 79.3075V71.7059C38.0432 70.1323 38.656 68.6526 39.7688 67.5399L42.2873 65.0214L45.299 68.0341C46.0312 68.7663 47.2191 68.7663 47.9514 68.0341C48.6835 67.3019 48.6833 66.115 47.9514 65.3827L44.9387 62.37L49.3166 57.9921L52.3283 61.0048C53.0606 61.737 54.2485 61.737 54.9807 61.0048C55.7126 60.2726 55.7126 59.0856 54.9807 58.3534L51.968 55.3407L56.3459 50.9628L59.3576 53.9755C60.0899 54.7077 61.2778 54.7077 62.01 53.9755C62.7419 53.2433 62.7419 52.0563 62.01 51.3241L58.9973 48.3114L63.3742 43.9335L60.6838 41.243C59.9516 40.5108 59.9516 39.3239 60.6838 38.5917Z"
            fill="#EBD5BD"
          />
          <path
          ...
          />
          <path
            d="M91.4507 41.3306L78.6697 28.5497C77.9375 27.8174 76.7503 27.8174 76.018 28.5497C75.2858 29.2819 75.2858 30.4691 76.018 31.2013L81.0827 36.2659L73.6973 43.6513L76.3489 46.303L83.7343 38.9176L88.7991 43.9823C89.5311 44.7145 90.7184 44.7147 91.4507 43.9823C92.1828 43.25 92.1828 42.0628 91.4507 41.3306Z"
            fill="#EBD5BD"
          />
        </svg>
      ...
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        <div className="w-full border bg-[var(--color-card)] rounded-xl shadow-lg p-6 flex flex-col items-center mb-4">
          ...
          >
            <label
              onClick={() =>
                document.getElementById("vaccine-upload-id")?.click()
              }
              htmlFor="file-upload"
