...
const EditVaccineModal: React.FC<EditVaccineModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--color-modal)]/60 backdrop-blur-sm px-2 sm:px-0">
      <div className="relative bg-[var(--color-background)] rounded-2xl shadow-2xl px-4 sm:px-10 py-3 sm:py-4 w-full max-w-xs sm:max-w-md flex flex-col max-h-[90%] overflow-y-auto items-center border border-[var(--color-border)]">
          {/* Close button */}
          <button
