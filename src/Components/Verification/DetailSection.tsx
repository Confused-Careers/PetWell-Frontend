    ...
    <div className="max-w-7xl mx-auto w-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full items-stretch">
        <div className="flex flex-col w-full h-full">
          ...
          <div className="bg-[var(--color-card-profile)] rounded-2xl shadow-md p-6 flex flex-col relative min-w-[200px] w-full h-full">
            <button
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-4">
              <img
                src={petImage}
                alt={petName}
                className="size-15 md:size-20 rounded-full object-cover border-2 border-[var(--color-primary)]"
              />
              <span className="text-md sm:text-xl md:text-2xl font-semibold text-[var(--color-text)] break-words max-w-full">
                {petName}
              </span>
            </div>
            <div className="grid grid-cols-3 gap-y-2 sm:gap-y-3 gap-x-2 sm:gap-x-4 text-base">
              <div>
        ...
        <div className="flex flex-col w-full h-full">
          ...
          <div className="bg-[var(--color-card-vaccine-green)] rounded-2xl shadow-md p-6 flex flex-col relative min-w-[200px] w-full h-full">
            <button
              className="absolute top-2 sm:top-3 right-2 sm:right-3 text-[var(--color-primary)] hover:bg-[var(--color-primary)]/10 rounded-full p-1 sm:p-2"
              onClick={onEditUser}
