        ...
        <div className="flex flex-row gap-6">
          <div className="space-y-6 max-w-[32%]">
            <div className="bg-[#6A8293] rounded-[24px] p-6 text-white border border-black">
              ...
              <h1 className="text-4xl font-[cabin, sans-serif] text-[#FFF8E5] font-[400] mb-4">
                {pet.pet_name || "Pet"}
              </h1>
              <div className="flex flex-row gap-8 text-sm">
                <div className="flex flex-col gap-3">
                  <div>
                    <span className="text-[#FFF8E599]/60 font-[400] text-[20px]">
                      Age
                    </span>
          ...
          <div className="space-y-6">
            <div className="bg-[#EDCC79] rounded-3xl p-4 border border-black flex flex-col">
              <h2 className="text-[36px] font-[cabin, sans-serif] font-[500] mb-2 text-[#1C232E]">
                Health Summary
              </h2>
              <div className="flex flex-col gap-4 text-sm mb-2">
                <div className="flex flex-row gap-8 items-start">
                  <div>
                    <span className="text-[#1C232E] opacity-60 text-[16px]">
                      Spay/Neuter Status
                    </span>
                    <div className="font-[500] text-[#1C232E] text-[20px]">
              ...
              <div className="pt-4 mb-2">
                ...
                <div className="text-red-500 font-[400] flex flex-row text-[20px]">
                  <p className="font-[600] text-[20px] text-[#1C232E]">
                    {" "}
                  ...
                  {pet.next_due_vaccine.date_due
                    ...
                    : "--"}{" "}
                  days <FaCircleExclamation className="mt-1.5 ml-1" />
                  &nbsp;{" "}
                  <p className="font-[600] text-[20px] flex flex-row text-[#1C232E]">
                    <span className="font-[400]">|</span> &nbsp;{" "}
                    <button className="font-[600] text-[20px] flex flex-row cursor-pointer">
                      &nbsp; View Document{" "}
                      <IoIosArrowDroprightCircle
            ...
            <div className="flex flex-row gap-6 justify-center">
              <div className="bg-[#ABA75C]/50 rounded-3xl p-4 border border-black min-w-[55%]">
                <h2 className="text-[24px] font-[cabin, sans-serif] font-[500] mb-4 text-[#1C232E]">
                  Parent Details
                </h2>
                <div className="flex flex-col gap-4 text-sm">
                  <div className="flex flex-row gap-8 items-start">
                    <div>
                      ...
                      <div className="font-[500] text-[#1C232E] text-[20px]">
                        {pet.human_owner.human_owner_name}
                      </div>
                    </div>
                    <div>
                      <span className="text-[#1C232E] opacity-60 text-[16px]">
