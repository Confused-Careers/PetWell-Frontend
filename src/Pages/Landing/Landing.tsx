...
const Landing: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[var(--color-background)] opacity-40"></div>
      ...
      <div className="relative z-10 w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl mx-4 px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl p-6 sm:p-8 md:p-12 lg:p-16 shadow-2xl flex flex-col items-center min-h-[400px] sm:min-h-[450px] md:min-h-[500px] lg:min-h-[520px] justify-center gap-6 sm:gap-8 md:gap-10 bg-[var(--color-card)]/90 backdrop-blur-lg">
          ...
          <div className="text-center mb-2">
            <h1 className="font-bold mb-2 text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[140px] leading-[1] font-[Alike,serif] text-[var(--color-text)]">
              PetWell
            </h1>
            <div className="flex items-center justify-center gap-2 text-lg sm:text-xl md:text-2xl lg:text-[25px] font-[Cabin,sans-serif] text-[var(--color-text)] px-2">
